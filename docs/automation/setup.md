---
title: Setting Up SDK & CLI Tool
description: Instructions on SDK installation, setting up the API key, and using the CLI tool effectively for accessing Netlas services.
---
